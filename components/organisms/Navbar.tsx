...
export function Navbar() {
  return (
    <nav className="hidden xl:flex items-center gap-10 text-[11px] font-bold text-black tracking-[0.1em]">
      ...
      <Link href="/about" className="hover:text-blue-600 transition-colors">MAS SOBRE NOSOTROS</Link>
      ...
      <Link href="/contact" className="hover:text-blue-600 transition-colors">CONTACTANOS</Link>
    </nav>
  );
}
